...
public class DexUtil {
    ...
    public static void insertDex(DexClassLoader dexClassLoader,Context context) throws Exception {
        ...
        insertNativeLibrary(dexClassLoader,context);
    ...
    private static synchronized void insertNativeLibrary(DexClassLoader dexClassLoader,Context context) throws Exception {
